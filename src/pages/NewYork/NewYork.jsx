...
function NewYorkCards(){
    let[api,setApi]=useState([])
    useEffect(()=>{
    let res=fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures?city=new-york").then(x=>x.json()).then(x=>{
        // console.log(x);
        setApi(x)
    })
    },[])
